# Set up variables
$connectionString = '"Host=ep-curly-mode-a9asjbm7-pooler.gwc.azure.neon.tech;Port=5432;Database=GroceryShopDb;Username=neondb_owner;Password=npg_PSkeBHfZim73;SslMode=Require"'
$provider = "Npgsql.EntityFrameworkCore.PostgreSQL"
$outputDirTemp = "Data\Entities\EF2"
$outputDirMain = "Data\Entities\EF"
$contextDir = "Data"
$contextName = "GroceryShopContext"
$project = "ShopAnalytics.csproj"
$namespaceOld = "ShopAnalytics.Data.Entities.EF2"
$namespaceNew = "ShopAnalytics.Data.Entities.EF"
...
# Step 6: Update namespace in GroceryShopContext.cs
Show-Loading
